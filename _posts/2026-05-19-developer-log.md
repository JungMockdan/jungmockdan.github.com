...
SoT verify §Step 5 prod 표 · Step 5 보드 **미완**.
...
| **해결** | `/terms-agreement` 재동의 후 재시도; 지속 시 UTA·TERMS 버전 점검 (미구현) |
...
> 잔여 출처: [05-18 §5](/2026-05-18-developer-log#5-다음-액션) · 보드 `artifact/ops/tasks/board.md`.

### 5.1 미완

| Task ID | 항목 |
|---------|------|
| `PHASE17-LOCAL-PROD-REGRESSION-01` | Step 5 prod — M1-4·M4 재검증(온보딩·선택약관 수정 반영 후) |
