# Spring boot security , jwt, cors

```java
package com.ksmartech.connect.security.config;

import com.ksmartech.connect.security.Role;
import com.ksmartech.connect.security.filter.JwtAuthenticationFilter;
import com.ksmartech.connect.security.util.JwtUtil;
...
```java
package com.ksmartech.connect.security.filter;

import com.ksmartech.connect.security.util.JwtConstants;
import com.ksmartech.connect.security.util.JwtUtil;
