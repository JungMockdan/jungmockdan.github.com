...
| 0b | [x] 로컬 스모크: optional-terms → marketing-channels ON | `TERMS-OPTIONAL-CONSENT-MYPAGE-01` | [05-19 §2.6](/2026-05-19-developer-log#26-수동-verify-0b--워크플로-정리-개발-운영) · verify §6 PASS |
